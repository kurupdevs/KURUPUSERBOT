...
if __name__ == "__main__":
    ...
    if install_type == "1":
        restart = "pm2 restart Kurup"
    elif install_type == "2":
        restart = "sudo systemctl restart Kurup"
    else:
        restart = "cd KurupUserbot/ && python main.py"

    app.start()
    try:
        app.send_message(
            "me",
            f"<b>[{datetime.now()}] KurupUserbot launched! \n"
            "Channel: @kurupuserbot\n"
            "Custom modules: @kurupub_modules\n"
            "Chat: @kurupub_chat\n"
